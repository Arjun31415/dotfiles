...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "cmp-nvim-ultisnips", "cmp-tabnine", "copilot-cmp", "cmp-nvim-lsp", "cmp-path", "cmp-cmdline" },
    loaded = true,
    only_config = true
  },
  ["nvim-colorizer.lua"] = {
...
vim.cmd [[au FileType tex ++once lua require("packer.load")({'vimtex', 'vim-angry-reviewer'}, { ft = "tex" }, _G.packer_plugins)]]
...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'vim-kitty', 'nvim-notify', 'cmp-buffer', 'cmp-tabnine', 'vimtex', 'refactoring.nvim', 'renamer.nvim', 'spotify.nvim', 'hlargs.nvim', 'trouble.nvim', 'presence.nvim', 'instant.nvim', 'cmp-nvim-lsp', 'nvim-ts-rainbow', 'blamer.nvim', 'cmp-path', 'cmp-cmdline', 'nvim-autopairs', 'vim-signify', 'nvim-colorizer.lua'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'alpha-nvim', 'vim-matchup', 'vim-repeat', 'vim-sandwich', 'vim-swap', 'open-browser.vim', 'which-key.nvim', 'whitespace.nvim', 'targets.vim', 'hop.nvim', 'indent-blankline.nvim', 'bufferline.nvim', 'AutoSave.nvim', 'unicode.vim', 'lualine.nvim', 'vim-asterisk', 'vim-commentary', 'neoscroll.nvim', 'vim-highlighturl', 'vim-indent-object'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'copilot.lua', 'better-escape.vim', 'ultisnips', 'gh.nvim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
